        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("Movies Channel", url="https://t.me/Cinema_files_links"),
                        InlineKeyboardButton("Owner", url="https://t.me/OneLuffyD")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://t.me/OneLuffyD)",
                                     disable_web_page_preview=True)
            return
    ...
    if "aboutbot" in cb_data:
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Movvies channel", url="https://t.me/Cinema_files_links")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("About Dev", callback_data="aboutdevs"),
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Owner](https://t.me/OneLuffyD).",
                        disable_web_page_preview=True
                    )
                    return
            except UserNotParticipant:
                invite_link = await get_invite_link(channel_chat_id, chat_id)
                await cmd.message.edit(
                    text="**I like Your Smartness But Don't Be Oversmart! 😑**\n\n",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("🤖 Join Updates Channel & try link again", url=invite_link.invite_link)
                            ],
                            [
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Owner](https://t.me/OneLuffyD).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
