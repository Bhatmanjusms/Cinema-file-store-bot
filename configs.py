...
class Config(object):
	...
	SHORTLINK_URL = os.environ.get('SHORTLINK_URL', "Pdisk.site")
	SHORTLINK_API = os.environ.get('SHORTLINK_API', "21a07f75db825882a5d0062d1ffb9f52730cb149")
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5568040597"))
